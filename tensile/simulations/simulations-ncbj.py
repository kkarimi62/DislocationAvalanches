...
if __name__ == '__main__':
    ...
    #
    jobname  = {
                4:'test-mpi',#'NiCoCrNatom10KTemp300KMultipleRates/Rate0', 
               }[4]
    ...
    def SetVariables():
        Variable = {
                ...
                6:' -var buff 0.0 -var T 300 -var P 0.0 -var gammaxy 0.001 -var gammadot 0.5e-4 -var nthermo 10000 -var ndump 1000 -var ParseData 1 -var DataFile equilibrated.dat -var DumpFile dumpSheared.xyz',
    ...
    #--- binary files
    EXEC_lmp = ['lmp_g++_openmpi','lmp_intel_cpu_intelmpi','lmp_omp'][1]
