...
if __name__ == '__main__':
		...
		def SetVariables():
			Variable = {
					...
					5:' -var buff 0.0 -var nevery 1000 -var ParseData 0 -var natoms 54600 -var ntype 5 -var cutoff 3.54  -var DumpFile dumpMin.xyz -var WriteData data_minimized.txt -var seed0 %s -var seed1 %s -var seed2 %s -var seed3 %s'%tuple(np.random.randint(1001,9999,size=4)), 
