        ...
        for script,var,indx, execc in zip(Pipeline,Variables,range(100),EXEC):
            ...
            if execc[:4] == 'lmp_':
                ...
                if execc == 'lmp_omp':
                    ...
                    if indx == 0: 
                        print >> someFile, 'spack load openmpi@4.0.5 %gcc@9.3.0\n\n',
                        print >> someFile, 'export OMP_NUM_THREADS=%s'%1 #nThreads
...
if __name__ == '__main__':
    ...
    def SetVariables():
        Variable = {
                ...
                6:' -var buff 0.0 -var T 300 -var P 0.0 -var gammaxy 0.0001 -var gammadot 0.5e-4 -var nthermo 10000 -var ndump 1000 -var ParseData 1 -var DataFile equilibrated.dat -var DumpFile dumpSheared.xyz',
