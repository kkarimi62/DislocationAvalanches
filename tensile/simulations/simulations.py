...
if __name__ == '__main__':
    ...
    nruns	 = range(24)
    #
    nThreads =  8 #32 #16 #4 #8
    nNode	 = 1
    #
    jobname  = {
                3:'CantorNatom10KTemp300KMultipleRates/Rate12', 
    ...
    def SetVariables():
        Variable = {
                ...
                6:' -var buff 0.0 -var T 300 -var P 0.0 -var gammaxy 1.0 -var gammadot 0.125e-4 -var nthermo 10000 -var ndump 1000 -var ParseData 1 -var DataFile equilibrated.dat -var DumpFile dumpSheared.xyz',
