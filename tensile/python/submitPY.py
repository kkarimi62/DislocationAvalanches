...
#				string[ inums ] = "\t\'3\':\'tensileCantor_tensile900_rate4_kernels/kernel%s\',\n"%(key) #--- change job name
				string[ inums ] = "\t\'4\':\'CantorNatom10KTemp%sK\',\n" % (int(PHI[key])) #--- change job name
		#---	densities
				inums = lnums[ 1 ] - 1
#				string[ inums ] = "\t\'1\':\'/../testdata/aedata/cantor/rateT900K/rate%s\',\n"%(int(PHI[key]))
				string[ inums ] = "\t\'4\':\'/../simulations/CantorNatom10KTemp%sKRate1e8\',\n"%(int(PHI[key]))
