...
#     confParser.set('Parameters','attributes','x    y    area    perimeter    subBoundaryLength  diameter    equivalentPerimeter    shapeFactor    isBoundary  hasHole    isInclusion    numNeighbors phi1 Phi phi2') 
...
#     confParser.set('flags','remote_machine','True')
    ...
    #
    confParser.set('test data files','ebsd_path',os.getcwd()+'/../nanoindentation/ebsd/output/before_irradiation')
    confParser.set('test data files','test_data_file_path',os.getcwd()+'/../nanoindentation/ebsd/output/before_irradiation/attributes.txt')
    confParser.set('test data files', 'test_data_file_path2nd', os.getcwd()+'/../nanoindentation/ebsd/output/before_irradiation/pairwise_attributes.txt')
    #
    confParser.set('Dislocation Density','alpha','alpha11')
    confParser.set('Dislocation Density','qlo','0.0')
    confParser.set('Dislocation Density','qhi','1.0')
    
    #--- write
    confParser.write(open('config_irradiated.ini','w'))
...
if __name__ == '__main__':
    ...
    jobname  = {
                    ...
                    3:'gndIradiation/before', #'learning_curve',
                }[ 3 ]
    ...
    PYFILdic = { 
        ...
        1:'gnnPolyCryst_irradiated.ipynb',
        }
    keyno = 1
    convert_to_py = True
#---
